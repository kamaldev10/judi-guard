...
const AnalisisSection = () => {
  return (
    <section
      ...
      className="py-16 sm:py-24 bg-slate-50" // Background sedikit berbeda untuk memisahkan section
    >
      <motion.div
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-10 lg:gap-16">
          ...
          >
            ...
            <motion.div variants={itemVariantsLeft}>
              <Link to="/analisis#analysis-form">
                {" "}
                {/* Tombol mengarah ke halaman analisis utama */}
                <motion.button
                  className="bg-teal-600 text-white font-semibold px-8 py-3 rounded-lg text-sm sm:text-base
