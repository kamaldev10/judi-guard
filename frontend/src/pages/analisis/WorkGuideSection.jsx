    ...
    >
      <div className="w-full max-w-4/5 mx-auto">
        <motion.h2
          ...
          className="text-center text-2xl sm:text-3xl lg:text-4xl font-bold text-teal-700 mb-10 md:mb-12 lg:mb-16 tracking-tight" // Font dan margin disesuaikan
        >
          Bagaimana Cara Kerjanya?
        </motion.h2>
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-5 md:gap-4 lg:gap-10">
          {steps.map((step, index) => (
            <React.Fragment key={index}>
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-teal-700 mb-1.5">
              ...
              {index < steps.length - 1 && (
                <>
                  ...
                  <motion.div
                    ...
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.5 }}
                    className="md:hidden flex items-center justify-center text-teal-400 self-center my-3" // Margin panah mobile
                  >
