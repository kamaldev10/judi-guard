...
router.use(isAuthenticated, ensureYoutubeAccess);
...
router.delete("/whitelist/:id", configController.deleteWhitelist);
...
router.delete("/blacklist/:id", configController.deleteBlacklist);
