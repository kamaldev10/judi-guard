...
export default function AnalysisScanning() {
  const {
    ...
    analysisStatus,
    analysisStats,
    error, // Ambil state error dari store
    cancelScanning, // Ambil action cancel/kembali
    ...
    return (
      <div className="flex min-h-[500px] w-full flex-col items-center justify-center space-y-6 py-12 animate-in zoom-in-95 duration-300">
        ...
        <div className="flex gap-4">
          <Button variant="outline" onClick={cancelScanning} className="gap-2">
            <ArrowLeft size={18} />
            Kembali ke Preview
          </Button>
        </div>
  ...
  return (
    <div className="flex min-h-[600px] w-full flex-col items-center justify-center space-y-8 py-12 animate-in fade-in duration-700">
      ...
      {/* Status Text & Button Cancel Manual */}
      <div className="text-center space-y-6 max-w-md">
        ...
        {/* Tombol Cancel (Optional: Jika user merasa terlalu lama) */}
        <Button
          variant="ghost"
          size="sm"
