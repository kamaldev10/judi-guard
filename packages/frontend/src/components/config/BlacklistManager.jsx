...
export default function BlacklistManager() {
  ...
  const handleKeyDown = async (e) => {
    if (e.key === 'Enter') {
      ...
      try {
        // Panggil Store (Store akan fetch ulang otomatis)
        const report = await addToBlacklist(input);
  ...
  return (
    <div className="h-full flex flex-col rounded-xl border bg-white shadow-sm dark:bg-gray-950 dark:border-gray-800">
