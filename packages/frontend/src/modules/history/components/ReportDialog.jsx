...
import { Calendar as CalendarIcon, Download, FileBarChart, Loader2 } from 'lucide-react';
...
export default function ReportDialog() {
  ...
  const { data: reportPreview, isLoading: isLoadingPreview } = useReportPreviewQuery(
    date,
    previewEnabled,
  );
  const downloadMutation = useDownloadPeriodReportMutation();
          ...
          {reportPreview && (
            <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2">
              ...
              <Button
                ...
                disabled={reportPreview.summary.totalVideos === 0 || downloadMutation.isPending}
              >
                <Download size={16} />
