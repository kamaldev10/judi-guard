...
describe('ConnectSection Component', () => {
  ...
  it('should render the main heading and description', () => {
    ...
    expect(screen.getByText(/fitur analisis canggih kami membantu anda/i)).toBeInTheDocument();
  });
  ...
  it('should render the illustration image correctly', () => {
    ...
    const image = screen.getByAltText(/ilustrasi analisis komentar judi guard/i);
