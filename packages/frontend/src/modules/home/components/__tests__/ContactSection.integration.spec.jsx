...
import ContactInfoList from '@/modules/home/components/ContactInfoList'; // Import for mocking
import ContactForm from '@/modules/home/components/ContactForm'; // Import for mocking
...
vi.mock('@/modules/home/components/ContactInfoList', () => ({
  default: vi.fn(() => <div data-testid="mock-contact-info">Info List</div>),
}));

// Mock ContactForm (interactive)
vi.mock('@/modules/home/components/ContactForm', () => ({
