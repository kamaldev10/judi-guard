...
vi.mock('@/modules/home/components/text-predict/TextPredictForm', () => ({
...
describe('Text Predict Section Component', () => {
  ...
  it('should render the main heading', () => {
    expect(screen.getByRole('heading', { level: 1, name: /judi guard ai/i })).toBeInTheDocument();
  });

  it('should render the description text', () => {
    expect(
      screen.getByText(/alat canggih untuk menganalisis dan memahami teks terkait perjudian/i),
    ).toBeInTheDocument();
  });
