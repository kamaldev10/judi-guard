...
describe('Tagline Component Testing', () => {
  ...
  it('should render the correct tagline text', () => {
    ...
    const taglineText = screen.getByText(/Membantu Anda Menjaga Ruang Digital Tetap Aman/i);
  ...
  it('should apply custom className when provided', () => {
    ...
    const taglineElement = screen.getByText(/Membantu Anda Menjaga Ruang Digital Tetap Aman/i);
