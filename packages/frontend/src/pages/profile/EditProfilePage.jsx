    ...
    return (
      ...
      >
        ...
        >
          ...
          <h2 className="text-xl md:text-2xl font-semibold text-red-600 mb-2">Gagal Memuat Data</h2>
          <p className="text-slate-700 text-sm md:text-base mb-6">{fetchError.message}</p>
          <button
